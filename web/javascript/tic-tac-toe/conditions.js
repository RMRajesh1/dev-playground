...
function check1(){
    ...
    if(
        (_("box0").innerHTML==star_icon) &&
        (_("box1").innerHTML==star_icon) &&
        (_("box2").innerHTML==star_icon)
    ){
        userWins(0,1,2);
    }
    else if(
        (_("box3").innerHTML==star_icon) &&
        (_("box4").innerHTML==star_icon) &&
        (_("box5").innerHTML==star_icon)
    ){
        userWins(3,4,5);
    }
    else if(
    ...
    // check cpuWins condions
        ...
        (_("box0").innerHTML==round_icon) &&
        (_("box1").innerHTML==round_icon) &&
        (_("box2").innerHTML==round_icon)
    ){
        cpuWins(0,1,2);
    }
    else if(
        (_("box3").innerHTML==round_icon) &&
        (_("box4").innerHTML==round_icon) &&
        (_("box5").innerHTML==round_icon)
    ){
        cpuWins(3,4,5);
    }
    else if(
...
function toWin(){
    ...
    if(
        ...
        console.log("entered to win (attempt)");
        if (_("box"+ele[n3]).innerHTML == ""){
            console.log("By AI to win");
            _("audio4").play();
...
function toDefeat(){
    ...
    if(
        ...
        console.log("entered to defeat (attempt)");
        if (_("box"+ele[n3]).innerHTML == ""){
            console.log("By AI to defeat User");
            _("audio4").play();
            _("box"+ele[n3]).innerHTML = round;
            random = false;
        }
